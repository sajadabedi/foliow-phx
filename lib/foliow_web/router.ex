defmodule FoliowWeb.Router do
  use FoliowWeb, :router

  import FoliowWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {FoliowWeb.Layouts, :root}
  ...
  # scope "/api", FoliowWeb do
  #   pipe_through :api
  # end

  # Enable LiveDashboard and Swoosh mailbox preview in development
  if Application.compile_env(:foliow, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: FoliowWeb.Telemetry
